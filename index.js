...
app.on('ready', () => {
  if (store.get('token') == null) {
    ...
    authWindow.loadURL(
      'https://pnut.io/oauth/authenticate?client_id=u2FIOMI4zYh_quby0QvzA94MvirO9VNg&redirect_uri=http://kyo5884.tk/enuts/auth_done&scope=basic,files,follow,messages,polls,presence,stream,update_profile,write_post&response_type=token'
    )
